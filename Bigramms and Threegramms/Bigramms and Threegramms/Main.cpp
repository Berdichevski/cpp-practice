...
int main() {
	...
	while (j != nullptr) 
	{
		while (i != nullptr) 
		{
			if (!i->getFoundBigrammEnd())
			{ 
				text.mostFrequentBigrammEnd(i);
				cout << endl;
			}
			if (!i->getFoundThreegrammEnd())
			{
				text.mostFrequentThreegrammEnd(i);
				cout << endl;
			}
			i = i->getNext();
		}
